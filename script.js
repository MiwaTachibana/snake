...
/*******************************************************/
	...
	{
		food = {
			//generates random coordinates for the food within the canvas height and width

			x: Math.floor(Math.random()*23.4), 
			y: Math.floor(Math.random()*21.5) 
		};
...
//////////////////////////////////////////////////////
		...
		//if the snake eats the food aka head position matches with the food position,
		//Create a new head, dont pop the tail
		...
		// snake moves by popping out the tail block and assigning it to the beginning of the array 
